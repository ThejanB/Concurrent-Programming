...
pthread_mutex_t mutex;           // Mutex for the entire list
...
int main(int argc, char* argv[]) {
    ...
    if (fabs(mMember_fraction + mInsert_fraction + mDelete_fraction - 1.0) > 0.0001) {
    ...
    save_results_to_file("results/mutex_results.txt", mMember_fraction, mInsert_fraction, mDelete_fraction, thread_count, mean, std_dev);
